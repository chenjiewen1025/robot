...
<form action="/Add.do" method="post"id="myform"  >
    ...
    指令： <input type="text" name="command" class="allInput" id="command"/>
    描述： <input type="text" name="description" class="allInput" id="description"/>
    回复：
    <textarea  name="content" id="content" class="allInput"  rows="10" cols="10"></textarea>
