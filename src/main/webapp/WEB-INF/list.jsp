...
<form action="/List.action" id="mainForm" method="post">
    <div class="right">
        ...
        <div class="rightCont">
            <p class="g_title fix">内容列表 <a class="btn03" href="/add.action">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03"  href="javascript:deleteSome()">删 除</a></p>
            <table class="tab1">
                <tbody>
                <tr>
...
<
                    ...
                    <tr <c:if test="${status.index % 2!=0}">style='background-color:#ECF6EE;'</c:if>>
                        ...
                        <td>
                            <a href="/update.action?id=${message.id}">修改</a>&nbsp;&nbsp;&nbsp;
                            <a href="/DeleteOneServlet.do?id=${message.id}">删除</a>
                        </td>
